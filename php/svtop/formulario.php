...
while ($r=$query->fetch_object()){
  ...
  $sql1= "SELECT sv08conse,sv01cedc,sv03cedp,sv04nfin,sv02code FROM sv08trmte where sv08conse ='$id'";
$query = $con->query($sql1);
$person = null;
if($query->num_rows>0){
while ($r=$query->fetch_object()){
...
<form role="form" method="post" action="php/svvsdo/actualizarv.php" enctype="multipart/form-data" onsubmit="return validar();">
